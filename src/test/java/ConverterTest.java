...
public class ConverterTest {
    ...
    public void celsiusToFahrenheitTest(){
        ...
        converter.result();
        assertEquals("Fahrenheit value: 104,000",output.toString().trim());
    }
    ...
    public void celsiusToKelvinTest(){
        ...
        converter.result();
        assertEquals("Kelvin value: 273,150",output.toString().trim());
    }
    ...
    public void fahrenheitToCelsiusTest(){
        ...
        converter.result();
        assertEquals("Celsius value: -268,333",output.toString().trim());
    }
    ...
    public void fahrenheitToKelvinTest(){
        ...
        converter.result();
        assertEquals("Kelvin value: 505,928",output.toString().trim());
    }
    ...
    public void kelvinToCelsiusTest(){
        ...
        converter.result();
        assertEquals("Celsius value: -216,150",output.toString().trim());
    }
    ...
    public void kelvinToFahrenheitTest(){
        ...
        converter.result();
        assertEquals("Fahrenheit value: -357,070",output.toString().trim());
    }
